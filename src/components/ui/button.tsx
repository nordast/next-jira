  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold border border-neutral-200 shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-gradient-to-b from-amber-500 to-amber-700 text-destructive-foreground hover:from-amber-700 hover:to-amber-700",
        ...
        teritary: "border-transparent bg-blue-100 text-blue-600 hover:bg-blue-200 shadow-none",
      },
      size: {
